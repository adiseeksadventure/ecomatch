          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <div className="flex justify-between items-center mb-2 ml-1">
                ...
                <a href="#" className="text-[10px] font-black text-nature-primary uppercase tracking-widest hover:opacity-100 opacity-60 transition-opacity">
                  Forgot?
                </a>
              </div>
              <input
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-[10px]">
                <span className="px-4 bg-white text-nature-sage font-black uppercase tracking-widest">or continue with</span>
              </div>
            </div>
